...
- [ ] CHANGELOG has a section for this release covering discovery, the picker, scoped preview and recording, reconcile's media merging, and restore, with its compare links extended
...
- [ ] The version is bumped (minor - the Patch contract gains a dimension)
